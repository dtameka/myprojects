...
int main(void) {
Suite *s1 = suite_create("s21_3Dviewer");
TCase *tc1_1 = tcase_create("s21_parser");
SRunner *sr = srunner_create(s1);
int nf;

suite_add_tcase(s1, tc1_1);
tcase_add_test(tc1_1, s21_parser_test_1);
tcase_add_test(tc1_1, s21_moveX_test_2);
tcase_add_test(tc1_1, s21_moveY_test_3);
tcase_add_test(tc1_1, s21_moveZ_test_4);
tcase_add_test(tc1_1, s21_rotateX_test_5);
tcase_add_test(tc1_1, s21_rotateY_test_6);
tcase_add_test(tc1_1, s21_rotateY_test_7);
tcase_add_test(tc1_1, s21_scale_test_8);
tcase_add_test(tc1_1, s21_minmax_test_9);
tcase_add_test(tc1_1, s21_parser_test_10);
